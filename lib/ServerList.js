 ...
 */
function ServerList(connectionString) {
    ...
    if (servers.length === 0) {
        throw new Error('connectionString must contain at least on server.');
    }

    // Randomize the list.
    this.servers = u.shuffe(servers);
}
 ...
 */
ServerList.prototype.getConnectionString = function () {
    return this.connectionString;
};

ServerList.prototype.getChrootPath = function () {
